...
class NotAddedDeviceAdapter(
    private val mContext: Context,
    private val list: ArrayList<GroupDeviceDetailBean>
) : RecyclerView.Adapter<NotAddedDeviceHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NotAddedDeviceHolder {
        return NotAddedDeviceHolder(
    ...
    override fun onBindViewHolder(holder: NotAddedDeviceHolder, position: Int) {
        ...
        if (groupBean.isOnline) {
            ...
            holder.imgIcon.setBackgroundResource(R.drawable.group_shape_add)
            ...
            val drawableRight = mContext.resources.getDrawable(R.mipmap.group_icon_delete)
            holder.imgIcon.setImageDrawable(drawableRight)
            holder.imgIcon.setBackgroundResource(R.drawable.group_shape_notadd_offline)
...
class NotAddedDeviceHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
