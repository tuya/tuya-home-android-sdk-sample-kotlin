 ...
 */
class PasswordOldOfflineAddActivity: AppCompatActivity() {

    companion object {
        fun startActivity(context: Context?, devId: String?, passwordType: String) {
            val intent = Intent(context, PasswordOldOfflineAddActivity::class.java)
            //设备id
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when (type) {
            Constant.TYPE_SINGLE -> pwdType = OfflineTempPasswordType.SINGLE
            Constant.TYPE_MULTIPLE -> pwdType = OfflineTempPasswordType.MULTIPLE
            Constant.TYPE_CLEAR_ALL -> pwdType = OfflineTempPasswordType.CLEAR_ALL
        }
        ...
        findViewById<View>(R.id.password_offline_add).setOnClickListener { v: View? -> getOfflinePassword() }
    }
    ...
    private fun getOfflinePassword() {
        tuyaLockDevice!!.getOfflinePassword(
            pwdType,
            gmtStart,
            gmtExpired,
            name,
